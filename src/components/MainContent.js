      ...
      <Container fluid="true" className="mainContent">
        <Row>
          <Col lg>
            <Card>
              <Card.Body>
                <h4 className="professional-summary">professional summary</h4>
                <p>
                  <b>Full stack web application developer/engineer</b>,
                  experienced in a variety of languages and frameworks:
                  JavaScript MEVN/MERN/MEAN (Node, Express, Mongo,
                  Vue/React/Angular), LAMP (PHP/Hacklang, XHP/React/Flow),
                  Python (Django, Flask) stacks. Skillful knowledge of
                  MySQL/NoSQL databases. Goal-oriented communicator, strong work
                  ethic.
                </p>
              </Card.Body>
            </Card>
